      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-72 max-w-[calc(100vw-2rem)] bg-gray-900/95 backdrop-blur-md rounded-xl shadow-2xl border border-gray-700/50 z-50 overflow-hidden"
          >
            {/* Header */}
            ...
            {/* Filter Options */}
            <div className="p-3 space-y-3 max-h-[30vh] overflow-y-auto custom-scrollbar">
              {/* Year Filter */}
              <div>
